...
def compute_sigma_vector__H1__h1_h1__CAEE_CCEE(mr_adc, X_aaaa, X_abab, X_bbbb, sigma):
    ...
    sigma_KWCD_aaaa =- einsum('KiCD,iW->KWCD', X_aaaa, h_xa, optimize = einsum_type)
    sigma_KWCD_aaaa += einsum('KiCD,i,iW->KWCD', X_aaaa, e_cvs, t1_xa, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,Wx,ix->KWCD', X_aaaa, h_aa, t1_xa, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,iWxy,yx->KWCD', X_aaaa, v_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ixyW,xy->KWCD', X_aaaa, v_xaaa, rdm_ca, optimize = einsum_type)
    ...
    sigma_KWCD_aaaa += einsum('KiCD,i,ixWy,yx->KWCD', X_aaaa, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa -= 1/2 * einsum('KiCD,i,ixyW,yx->KWCD', X_aaaa, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,Wx,iyxz,yz->KWCD', X_aaaa, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,Wx,iyzx,yz->KWCD', X_aaaa, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += einsum('KiCD,xy,ixWz,yz->KWCD', X_aaaa, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa -= 1/2 * einsum('KiCD,xy,ixzW,yz->KWCD', X_aaaa, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,xy,izWx,yz->KWCD', X_aaaa, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,xy,izxW,yz->KWCD', X_aaaa, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,ix,Wxyz,yz->KWCD', X_aaaa, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ix,Wyzx,zy->KWCD', X_aaaa, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += einsum('KiCD,ixWy,xzwu,ywzu->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,ixWy,yzwu,xwzu->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa -= 1/2 * einsum('KiCD,ixyW,xzwu,ywzu->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ixyW,yzwu,xwzu->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ixyz,Wwuy,xwzu->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ixyz,Wwuz,xwuy->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa -= 1/2 * einsum('KiCD,ixyz,Wwxu,yzwu->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,ixyz,Wywu,xuzw->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa -= einsum('KiCD,ixyz,Wywz,xw->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ixyz,Wzwu,xuyw->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_aaaa += 1/2 * einsum('KiCD,ixyz,Wzwy,xw->KWCD', X_aaaa, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma[caee__aaaa] += ascontiguousarray(sigma_KWCD_aaaa[:, :, ee_tril_ind[0], ee_tril_ind[1]]).reshape(-1)

    sigma_KWCD_abab =- einsum('KiCD,iW->KWCD', X_abab, h_xa, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCa,iaDx,Wx->KWCD', X_aaaa, v_xeea, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += einsum('KiCD,i,iW->KWCD', X_abab, e_cvs, t1_xa, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,Wx,ix->KWCD', X_abab, h_aa, t1_xa, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,iWxy,yx->KWCD', X_abab, v_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ixyW,xy->KWCD', X_abab, v_xaaa, rdm_ca, optimize = einsum_type)
    ...
    sigma_KWCD_abab += einsum('KiCD,i,ixWy,yx->KWCD', X_abab, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab -= 1/2 * einsum('KiCD,i,ixyW,yx->KWCD', X_abab, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,Wx,iyxz,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,Wx,iyzx,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += einsum('KiCD,xy,ixWz,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab -= 1/2 * einsum('KiCD,xy,ixzW,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,xy,izWx,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,xy,izxW,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,ix,Wxyz,yz->KWCD', X_abab, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ix,Wyzx,zy->KWCD', X_abab, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += einsum('KiCD,ixWy,xzwu,ywzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,ixWy,yzwu,xwzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab -= 1/2 * einsum('KiCD,ixyW,xzwu,ywzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ixyW,yzwu,xwzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ixyz,Wwuy,xwzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ixyz,Wwuz,xwuy->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab -= 1/2 * einsum('KiCD,ixyz,Wwxu,yzwu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,ixyz,Wywu,xuzw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab -= einsum('KiCD,ixyz,Wywz,xw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ixyz,Wzwu,xuyw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_abab += 1/2 * einsum('KiCD,ixyz,Wzwy,xw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma[caee__abab] += ascontiguousarray(sigma_KWCD_abab).reshape(-1)

    sigma_KWCD_baba =- einsum('iKDC,iW->KWCD', X_abab, h_xa, optimize = einsum_type)
    sigma_KWCD_baba += einsum('iKDC,i,iW->KWCD', X_abab, e_cvs, t1_xa, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,Wx,ix->KWCD', X_abab, h_aa, t1_xa, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,iWxy,yx->KWCD', X_abab, v_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ixyW,xy->KWCD', X_abab, v_xaaa, rdm_ca, optimize = einsum_type)
    ...
    sigma_KWCD_baba += einsum('iKDC,i,ixWy,yx->KWCD', X_abab, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba -= 1/2 * einsum('iKDC,i,ixyW,yx->KWCD', X_abab, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,Wx,iyxz,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,Wx,iyzx,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += einsum('iKDC,xy,ixWz,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba -= 1/2 * einsum('iKDC,xy,ixzW,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,xy,izWx,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,xy,izxW,yz->KWCD', X_abab, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,ix,Wxyz,yz->KWCD', X_abab, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ix,Wyzx,zy->KWCD', X_abab, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += einsum('iKDC,ixWy,xzwu,ywzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,ixWy,yzwu,xwzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba -= 1/2 * einsum('iKDC,ixyW,xzwu,ywzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ixyW,yzwu,xwzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ixyz,Wwuy,xwzu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ixyz,Wwuz,xwuy->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba -= 1/2 * einsum('iKDC,ixyz,Wwxu,yzwu->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,ixyz,Wywu,xuzw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba -= einsum('iKDC,ixyz,Wywz,xw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ixyz,Wzwu,xuyw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_baba += 1/2 * einsum('iKDC,ixyz,Wzwy,xw->KWCD', X_abab, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma[caee__baba] += ascontiguousarray(sigma_KWCD_baba).reshape(-1)

    sigma_KWCD_bbbb =- einsum('KiCD,iW->KWCD', X_bbbb, h_xa, optimize = einsum_type)
    ...
    sigma_KWCD_bbbb += einsum('KiCD,i,iW->KWCD', X_bbbb, e_cvs, t1_xa, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,Wx,ix->KWCD', X_bbbb, h_aa, t1_xa, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,iWxy,yx->KWCD', X_bbbb, v_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ixyW,xy->KWCD', X_bbbb, v_xaaa, rdm_ca, optimize = einsum_type)
    ...
    sigma_KWCD_bbbb += einsum('KiCD,i,ixWy,yx->KWCD', X_bbbb, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb -= 1/2 * einsum('KiCD,i,ixyW,yx->KWCD', X_bbbb, e_cvs, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,Wx,iyxz,yz->KWCD', X_bbbb, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,Wx,iyzx,yz->KWCD', X_bbbb, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += einsum('KiCD,xy,ixWz,yz->KWCD', X_bbbb, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb -= 1/2 * einsum('KiCD,xy,ixzW,yz->KWCD', X_bbbb, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,xy,izWx,yz->KWCD', X_bbbb, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,xy,izxW,yz->KWCD', X_bbbb, h_aa, t1_xaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,ix,Wxyz,yz->KWCD', X_bbbb, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ix,Wyzx,zy->KWCD', X_bbbb, t1_xa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += einsum('KiCD,ixWy,xzwu,ywzu->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,ixWy,yzwu,xwzu->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb -= 1/2 * einsum('KiCD,ixyW,xzwu,ywzu->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ixyW,yzwu,xwzu->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ixyz,Wwuy,xwzu->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ixyz,Wwuz,xwuy->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb -= 1/2 * einsum('KiCD,ixyz,Wwxu,yzwu->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,ixyz,Wywu,xuzw->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb -= einsum('KiCD,ixyz,Wywz,xw->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ixyz,Wzwu,xuyw->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWCD_bbbb += 1/2 * einsum('KiCD,ixyz,Wzwy,xw->KWCD', X_bbbb, t1_xaaa, v_aaaa, rdm_ca, optimize = einsum_type)
...
def compute_sigma_vector__H1__h1_h1__CAAA_CCEE(mr_adc, X_aaaa, X_abab, X_bbbb, sigma):
    ...
    sigma_KWUV_aaaa -= 1/12 * einsum('Kiab,ixab,Wyxz,UVyz->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_aaaa += 1/12 * einsum('Kiab,ixab,Wyxz,UVzy->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_aaaa += 1/12 * einsum('Kiab,ixba,Wyxz,UVyz->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_aaaa -= 1/12 * einsum('Kiab,ixba,Wyxz,UVzy->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_aaaa += 1/6 * einsum('Kiab,ixba,Wyxz,UVyz->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_aaaa -= 1/6 * einsum('Kiab,ixba,Wyxz,UVzy->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_abab += 1/12 * einsum('Kiab,ixab,Wyxz,UVyz->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_abab += 1/6 * einsum('Kiab,ixab,Wyxz,UVzy->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_abab -= 1/12 * einsum('Kiab,ixba,Wyxz,UVyz->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_abab -= 1/6 * einsum('Kiab,ixba,Wyxz,UVzy->KWUV', X_aaaa, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_abab -= 1/6 * einsum('Kiab,ixba,Wyxz,UVyz->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_abab -= 1/3 * einsum('Kiab,ixba,Wyxz,UVzy->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_baba -= 1/6 * einsum('iKab,ixab,Wyxz,UVyz->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_baba -= 1/3 * einsum('iKab,ixab,Wyxz,UVzy->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_baba += 1/12 * einsum('Kiab,ixab,Wyxz,UVyz->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_baba += 1/6 * einsum('Kiab,ixab,Wyxz,UVzy->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_baba -= 1/12 * einsum('Kiab,ixba,Wyxz,UVyz->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_baba -= 1/6 * einsum('Kiab,ixba,Wyxz,UVzy->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_bbbb += 1/6 * einsum('iKab,ixab,Wyxz,UVyz->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_bbbb -= 1/6 * einsum('iKab,ixab,Wyxz,UVzy->KWUV', X_abab, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_bbbb -= 1/12 * einsum('Kiab,ixab,Wyxz,UVyz->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_bbbb += 1/12 * einsum('Kiab,ixab,Wyxz,UVzy->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    ...
    sigma_KWUV_bbbb += 1/12 * einsum('Kiab,ixba,Wyxz,UVyz->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
    sigma_KWUV_bbbb -= 1/12 * einsum('Kiab,ixba,Wyxz,UVzy->KWUV', X_bbbb, t1_xaee, v_aaaa, rdm_ccaa, optimize = einsum_type)
