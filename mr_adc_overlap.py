...
def compute_S12_p1p_projector_alt(mr_adc):
...
#    S22_aba_aba = S22_bba_bba.transpose(0,2,1,3,5,4).copy() ## can use S22_aaa_bba = S22_aaa_aaa - S22_aba_aba + S22_aba_aba.transpose(0,2,1,3,4,5)
    ...
    S22_aaa_aaa = S22_aaa_aaa.reshape(dim_wzy, dim_wzy)
    S22_aaa_bba = S22_aaa_bba.reshape(dim_wzy, dim_wzy)

    S22_bba_aaa = S22_bba_aaa.reshape(dim_wzy, dim_wzy)
    S22_bba_bba = S22_bba_bba.reshape(dim_wzy, dim_wzy)
    ...
    Q_aaa_aaa = Q_aaa_aaa.reshape(dim_wzy, dim_wzy)
    Q_aaa_bba = Q_aaa_bba.reshape(dim_wzy, dim_wzy)

    Q_bba_aaa = Q_bba_aaa.reshape(dim_wzy, dim_wzy)
    Q_bba_bba = Q_bba_bba.reshape(dim_wzy, dim_wzy)
