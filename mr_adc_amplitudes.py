...
from line_profiler import LineProfiler # DEBUG
...
def compute_amplitudes(mr_adc):
    ...
    # DEBUG
    lp = LineProfiler()
    lp_wrapper = lp(compute_t1_amplitudes)
    t1_amp = lp_wrapper(mr_adc)
    lp.print_stats()
    #
...
def compute_t1_m1p_sanity_check(mr_adc):
    ...
    V1_a_a -= 1/2 * einsum('zyxA,Xxyz->XA', v_aaae, rdm_ccaa, optimize = einsum_type)
    ...
    V2_aa_aa += 1/6 * einsum('zyxA,UXxVyz->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_aa_aa -= 1/6 * einsum('zyxA,UXxyVz->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_aa_aa -= 1/2 * einsum('xA,UV,Xx->XUVA', h_ae, np.identity(ncas), rdm_ca, optimize = einsum_type)
    V2_aa_aa -= 1/2 * einsum('UV,zyxA,Xxyz->XUVA', np.identity(ncas), v_aaae, rdm_ccaa, optimize = einsum_type)
    ...
    V2_ab_ab -= 1/12 * einsum('zyxA,UXxVyz->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ab += 1/12 * einsum('zyxA,UXxVzy->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ab -= 1/4 * einsum('zyxA,UXxyVz->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ab += 1/12 * einsum('zyxA,UXxyzV->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ab += 1/12 * einsum('zyxA,UXxzVy->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ab += 1/12 * einsum('zyxA,UXxzyV->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    ...
    V2_ab_ba += 1/4 * einsum('zyxA,UXxVyz->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ba -= 1/12 * einsum('zyxA,UXxVzy->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ba += 1/12 * einsum('zyxA,UXxyVz->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ba -= 1/12 * einsum('zyxA,UXxyzV->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ba -= 1/12 * einsum('zyxA,UXxzVy->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ba -= 1/12 * einsum('zyxA,UXxzyV->XUVA', v_aaae, rdm_cccaaa, optimize = einsum_type)
    V2_ab_ba -= 1/2 * einsum('xA,UV,Xx->XUVA', h_ae, np.identity(ncas), rdm_ca, optimize = einsum_type)
    V2_ab_ba -= 1/2 * einsum('UV,zyxA,Xxyz->XUVA', np.identity(ncas), v_aaae, rdm_ccaa, optimize = einsum_type)
...
def compute_t2_0p_singles(mr_adc, t1_amp):
    ...
    # t1_ce
    # V1  = einsum('ia,iAaI->IA', t1_ce, v_ceec, optimize = einsum_type)
    # V1 -= 1/2 * einsum('ia,iAIa->IA', t1_ce, v_cece, optimize = einsum_type)
    # V1 += einsum('ia,IiAa->IA', t1_ce, v_ccee, optimize = einsum_type)
    # V1 -= 1/2 * einsum('ia,iIAa->IA', t1_ce, v_ccee, optimize = einsum_type)
    # V1 += 1/2 * einsum('iA,Ixiy,xy->IA', t1_ce, v_caca, rdm_ca, optimize = einsum_type)
    # V1 -= 1/2 * einsum('iA,Ixiy,yx->IA', t1_ce, v_caca, rdm_ca, optimize = einsum_type)
    # V1 -= 1/4 * einsum('iA,Ixyi,xy->IA', t1_ce, v_caac, rdm_ca, optimize = einsum_type)
    # V1 += 1/4 * einsum('iA,Ixyi,yx->IA', t1_ce, v_caac, rdm_ca, optimize = einsum_type)
    # V1 += 1/2 * einsum('Ia,xAya,xy->IA', t1_ce, v_aeae, rdm_ca, optimize = einsum_type)
    # V1 -= 1/4 * einsum('Ia,xAya,yx->IA', t1_ce, v_aeae, rdm_ca, optimize = einsum_type)
    # V1 -= 1/4 * einsum('Ia,xAay,xy->IA', t1_ce, v_aeea, rdm_ca, optimize = einsum_type)
    # V1 += 1/4 * einsum('Ia,xAay,yx->IA', t1_ce, v_aeea, rdm_ca, optimize = einsum_type)
    ...
    V1 -= 1/2 * einsum('ijAx,ijkx->IA', t1_ccea, v_ccca, optimize = einsum_type)
    V1 += 1/2 * einsum('ijAx,jikx->IA', t1_ccea, v_ccca, optimize = einsum_type)
    V1 += 1/2 * einsum('ijAx,jjkx->IA', t1_ccea, v_ccca, optimize = einsum_type)
    V1 -= einsum('ijAx,jjkx->IA', t1_ccea, v_ccca, optimize = einsum_type)
    V1 -= 1/2 * einsum('ijAa,ijka->IA', t1_ccee, v_ccce, optimize = einsum_type)
    V1 += 1/2 * einsum('ijAa,jika->IA', t1_ccee, v_ccce, optimize = einsum_type)
    V1 += 1/2 * einsum('ijAa,jjka->IA', t1_ccee, v_ccce, optimize = einsum_type)
    V1 -= einsum('ijAa,jjka->IA', t1_ccee, v_ccce, optimize = einsum_type)
    V1 += einsum('Iixy,iaxx->IA', t1_ccaa, v_ceaa, optimize = einsum_type)
    V1 += 2 * einsum('Iixy,iayx->IA', t1_ccaa, v_ceaa, optimize = einsum_type)
    V1 -= einsum('Iixy,iaxy->IA', t1_ccaa, v_ceaa, optimize = einsum_type)
    V1 -= einsum('Iixy,iayy->IA', t1_ccaa, v_ceaa, optimize = einsum_type)
    V1 += einsum('Iixy,iayy->IA', t1_ccaa, v_ceaa, optimize = einsum_type)
    V1 += 1/2 * einsum('Iiab,icba->IA', t1_ccee, v_ceee, optimize = einsum_type)
    ...
    V1 += 2 * einsum('IiAx,izxy,zy->IA', t1_ccea, v_caaa, rdm_ca, optimize = einsum_type)
    V1 -= einsum('IiAx,izyx,zy->IA', t1_ccea, v_caaa, rdm_ca, optimize = einsum_type)
    V1 -= einsum('IiAx,iyzw,xyzw->IA', t1_ccea, v_caaa, rdm_ccaa, optimize = einsum_type)
    V1 -= einsum('iIAx,izxy,zy->IA', t1_ccea, v_caaa, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('iIAx,izyx,zy->IA', t1_ccea, v_caaa, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('iIAx,iyzw,xyzw->IA', t1_ccea, v_caaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('ijAx,ijky,xy->IA', t1_ccea, v_ccca, rdm_ca, optimize = einsum_type)
    V1 -= 1/4 * einsum('ijAx,jiky,xy->IA', t1_ccea, v_ccca, rdm_ca, optimize = einsum_type)
    V1 -= 1/4 * einsum('ijAx,jjky,xy->IA', t1_ccea, v_ccca, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('ijAx,jjky,xy->IA', t1_ccea, v_ccca, rdm_ca, optimize = einsum_type)
    ...
    V1 += einsum('IxAa,wzya,zwxy->IA', t1_caee, v_aaae, rdm_ccaa, optimize = einsum_type)
    V1 += 2 * einsum('IiAa,iyax,yx->IA', t1_ccee, v_caea, rdm_ca, optimize = einsum_type)
    V1 -= einsum('IiAa,iyxa,yx->IA', t1_ccee, v_caae, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('xyAa,Iazw,zwxy->IA', t1_aaee, v_ceaa, rdm_ccaa, optimize = einsum_type)
    V1 -= einsum('iIAa,iyax,yx->IA', t1_ccee, v_caea, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('iIAa,iyxa,yx->IA', t1_ccee, v_caae, rdm_ca, optimize = einsum_type)
    V1 += einsum('Ix,zxyA,yz->IA', t1_ca, v_aaae, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ix,xzyA,yz->IA', t1_ca, v_aaae, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('Ixyz,uwxA,yzwu->IA', t1_caaa, v_aaae, rdm_ccaa, optimize = einsum_type)
    V1 += einsum('Ixyz,zywA,wx->IA', t1_caaa, v_aaae, rdm_ca, optimize = einsum_type)
    V1 += einsum('Ixyz,uywA,zwxu->IA', t1_caaa, v_aaae, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixyz,yzwA,wx->IA', t1_caaa, v_aaae, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixyz,uzwA,ywxu->IA', t1_caaa, v_aaae, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixyz,yuwA,zwxu->IA', t1_caaa, v_aaae, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixyz,zuwA,ywux->IA', t1_caaa, v_aaae, rdm_ccaa, optimize = einsum_type)
    ...
    V1 -= 1/2 * einsum('Ixya,zAwa,yzxw->IA', t1_caae, v_aeae, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixya,zAaw,yzwx->IA', t1_caae, v_aeea, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('IxaA,wzya,zwxy->IA', t1_caee, v_aaae, rdm_ccaa, optimize = einsum_type)
    V1 += einsum('Ixay,zAya,zx->IA', t1_caea, v_aeae, rdm_ca, optimize = einsum_type)
    V1 += einsum('Ixay,zAwa,yzxw->IA', t1_caea, v_aeae, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixay,zAay,zx->IA', t1_caea, v_aeea, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixay,zAaw,yzxw->IA', t1_caea, v_aeea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('Ixab,ycba,yx->IA', t1_caee, v_aeee, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('Iixy,iawz,xyzw->IA', t1_ccaa, v_ceaa, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('Iixy,iazw,xyzw->IA', t1_ccaa, v_ceaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/6 * einsum('Iixy,iazw,xywz->IA', t1_ccaa, v_ceaa, rdm_ccaa, optimize = einsum_type)
    V1 -= einsum('Iixy,iaxz,xz->IA', t1_ccaa, v_ceaa, rdm_ca, optimize = einsum_type)
    V1 -= 2 * einsum('Iixy,iazx,yz->IA', t1_ccaa, v_ceaa, rdm_ca, optimize = einsum_type)
    V1 += einsum('Iixy,iaxz,yz->IA', t1_ccaa, v_ceaa, rdm_ca, optimize = einsum_type)
    V1 += einsum('Iixy,iazy,xz->IA', t1_ccaa, v_ceaa, rdm_ca, optimize = einsum_type)
    V1 -= einsum('Iixy,iayz,xz->IA', t1_ccaa, v_ceaa, rdm_ca, optimize = einsum_type)
    V1 += 1/3 * einsum('Iixy,iazz,xyzw->IA', t1_ccaa, v_ceaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/6 * einsum('Iixy,iazz,xywz->IA', t1_ccaa, v_ceaa, rdm_ccaa, optimize = einsum_type)
    V1 += einsum('Ia,xAya,xy->IA', t1_ce, v_aeae, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ia,xAya,yx->IA', t1_ce, v_aeae, rdm_ca, optimize = einsum_type)
    ...
    V1 += 2 * einsum('izxy,iIxA,zy->IA', t1_caaa, v_ccae, rdm_ca, optimize = einsum_type)
    V1 -= einsum('izxy,IixA,zy->IA', t1_caaa, v_ccae, rdm_ca, optimize = einsum_type)
    V1 -= einsum('izxy,iIyA,zx->IA', t1_caaa, v_ccae, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('izxy,IiyA,zx->IA', t1_caaa, v_ccae, rdm_ca, optimize = einsum_type)
    ...
    V1 -= 5/6 * einsum('ixAy,Iziw,ywxz->IA', t1_caea, v_caca, rdm_ccaa, optimize = einsum_type)
    V1 += 1/12 * einsum('ixAy,Iziw,ywzx->IA', t1_caea, v_caca, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('ixAy,Izwi,ywxz->IA', t1_caea, v_caac, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += 1/3 * einsum('ixyA,Iziw,ywxz->IA', t1_caae, v_caca, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('ixyA,Iziw,ywzx->IA', t1_caae, v_caca, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('ixyA,Izwi,ywzx->IA', t1_caae, v_caac, rdm_ccaa, optimize = einsum_type)
    ...
    V1 -= einsum('ixyz,IwAi,yzwx->IA', t1_caaa, v_caec, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += 1/2 * einsum('ixyz,IwiA,yzwx->IA', t1_caaa, v_cace, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += einsum('A,IiAx,izxy,zy->IA', e_extern, t1_ccea, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 -= 1/2 * einsum('A,iIAx,izxy,zy->IA', e_extern, t1_ccea, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 -= einsum('I,IiAx,izxy,zy->IA', e_core, t1_ccea, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 += 1/2 * einsum('I,iIAx,izxy,zy->IA', e_core, t1_ccea, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 -= einsum('a,iyxa,IiAa,yx->IA', e_extern, t1_caae, t1_ccee, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('a,iyxa,iIAa,yx->IA', e_extern, t1_caae, t1_ccee, rdm_ca, optimize = einsum_type)
    V1 += 2 * einsum('a,iyax,IiAa,yx->IA', e_extern, t1_caea, t1_ccee, rdm_ca, optimize = einsum_type)
    V1 -= einsum('a,iyax,iIAa,yx->IA', e_extern, t1_caea, t1_ccee, rdm_ca, optimize = einsum_type)
    V1 += 2 * einsum('xy,IiAx,iwyz,wz->IA', h_aa, t1_ccea, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 -= einsum('xy,iIAx,iwyz,wz->IA', h_aa, t1_ccea, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 -= 1/2 * einsum('xy,iwxz,IiAz,wy->IA', h_aa, t1_caaa, t1_ccea, rdm_ca, optimize = einsum_type)
    V1 += 1/4 * einsum('xy,iwxz,iIAz,wy->IA', h_aa, t1_caaa, t1_ccea, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('xy,iwxz,IiAu,wuzy->IA', h_aa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('xy,iwxz,iIAu,wuzy->IA', h_aa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += einsum('xy,iwzx,IiAz,wy->IA', h_aa, t1_caaa, t1_ccea, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('xy,iwzx,iIAz,wy->IA', h_aa, t1_caaa, t1_ccea, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('xy,iwzx,IiAu,wuyz->IA', h_aa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('xy,iwzx,iIAu,wuyz->IA', h_aa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += 1/4 * einsum('Ixya,zAwa,wz,yx->IA', t1_caae, v_aeae, rdm_ca, rdm_ca, optimize = einsum_type)
    V1 -= 1/4 * einsum('Ixya,zAaw,wz,yx->IA', t1_caae, v_aeea, rdm_ca, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('Ixay,zAwa,wz,yx->IA', t1_caea, v_aeae, rdm_ca, rdm_ca, optimize = einsum_type)
    ...
    V1 += 2 * einsum('xyzw,IiAx,ivzu,wvyu->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    ...
    V1 -= einsum('xyzw,IiAx,ivwu,zvyu->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,IiAx,iyuv,zwuv->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('xyzw,IiAx,iu,zwuy->IA', v_aaaa, t1_ccea, t1_ca, rdm_ccaa, optimize = einsum_type)
    V1 -= einsum('xyzw,IiAx,iuvz,wuyv->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 -= einsum('xyzw,IiAx,iuvw,zuvy->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    ...
    V1 -= einsum('xyzw,iIAx,ivzu,wvyu->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += 1/2 * einsum('xyzw,iIAx,ivwu,zvyu->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/4 * einsum('xyzw,iIAx,iyuv,zwuv->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('xyzw,iIAx,iu,zwuy->IA', v_aaaa, t1_ccea, t1_ca, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,iIAx,iuvz,wuyv->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,iIAx,iuvw,zuvy->IA', v_aaaa, t1_ccea, t1_caaa, rdm_ccaa, optimize = einsum_type)
    ...
    V1 -= 1/2 * einsum('xyzw,iuxy,IiAv,uvwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('xyzw,iuxy,iIAv,uvwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('xyzw,ivxu,IiAu,yvwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/4 * einsum('xyzw,ivxu,iIAu,yvwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivxu,IiAs,yvszwu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivxu,IiAs,yvszuw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivxu,IiAs,yvswzu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 5/12 * einsum('xyzw,ivxu,IiAs,yvswuz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivxu,IiAs,yvsuzw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivxu,IiAs,yvsuwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivxu,iIAs,yvszwu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivxu,iIAs,yvszuw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivxu,iIAs,yvswzu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 5/24 * einsum('xyzw,ivxu,iIAs,yvswuz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivxu,iIAs,yvsuzw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivxu,iIAs,yvsuwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= einsum('xyzw,ixau,IiAa,zwuy->IA', v_aaaa, t1_caea, t1_ccee, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,ixau,iIAa,zwuy->IA', v_aaaa, t1_caea, t1_ccee, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,ixua,IiAa,zwuy->IA', v_aaaa, t1_caae, t1_ccee, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/4 * einsum('xyzw,ixua,iIAa,zwuy->IA', v_aaaa, t1_caae, t1_ccee, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += einsum('xyzw,ivux,IiAu,yvwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/2 * einsum('xyzw,ivux,iIAu,yvwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivux,IiAs,yvszwu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivux,IiAs,yvszuw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 5/12 * einsum('xyzw,ivux,IiAs,yvswzu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivux,IiAs,yvswuz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivux,IiAs,yvsuzw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,ivux,IiAs,yvsuwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivux,iIAs,yvszwu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivux,iIAs,yvszuw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 += 5/24 * einsum('xyzw,ivux,iIAs,yvswzu->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivux,iIAs,yvswuz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivux,iIAs,yvsuzw->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/24 * einsum('xyzw,ivux,iIAs,yvsuwz->IA', v_aaaa, t1_caaa, t1_ccea, rdm_cccaaa, optimize = einsum_type)
    V1 -= einsum('xyzw,ixuv,IiAu,zwvy->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,ixuv,iIAu,zwvy->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('xyzw,ixuv,IiAv,zwuy->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    V1 -= 1/4 * einsum('xyzw,ixuv,iIAv,zwuy->IA', v_aaaa, t1_caaa, t1_ccea, rdm_ccaa, optimize = einsum_type)
    ...
    if mr_adc.debug_mode:
        print (">>> SA t2_ce norm: {:}".format(np.linalg.norm(t2_ce)))
        with open('SA_t2_ce.out', 'w') as outfile:
            outfile.write(repr(t2_ce))
