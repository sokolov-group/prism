...
def compute_t2_p1p_singles(mr_adc):
    ...
    V1 += einsum('a,Iiab,iXab->IX', e_extern, t1_ccee, t1_caee, optimize = einsum_type)
    V1 -= 2 * einsum('a,Iiab,iXba->IX', e_extern, t1_ccee, t1_caee, optimize = einsum_type)
    V1 -= 2 * einsum('a,Iiba,iXab->IX', e_extern, t1_ccee, t1_caee, optimize = einsum_type)
    V1 += einsum('a,Iiba,iXba->IX', e_extern, t1_ccee, t1_caee, optimize = einsum_type)
    ...
    V1 -= einsum('i,Iiab,iXab->IX', e_core, t1_ccee, t1_caee, optimize = einsum_type)
    V1 += 2 * einsum('i,Iiab,iXba->IX', e_core, t1_ccee, t1_caee, optimize = einsum_type)
    V1 -= einsum('i,IixX,ix->IX', e_core, t1_ccaa, t1_ca, optimize = einsum_type)
    ...
    V1 -= 1/3 * einsum('ixyz,Iwui,Xuxwyz->IX', t1_caaa, v_caac, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('ixyz,Iwui,Xuxwzy->IX', t1_caaa, v_caac, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('ixyz,Iwui,Xuxywz->IX', t1_caaa, v_caac, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('ixyz,Iwui,Xuxyzw->IX', t1_caaa, v_caac, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('ixyz,Iwui,Xuxzwy->IX', t1_caaa, v_caac, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('ixyz,Iwui,Xuxzyw->IX', t1_caaa, v_caac, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= 1/6 * einsum('xyza,Iwua,Xuzwxy->IX', t1_aaae, v_caae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/3 * einsum('xyza,Iwua,Xuzwyx->IX', t1_aaae, v_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyza,Iwua,Xuzxwy->IX', t1_aaae, v_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyza,Iwua,Xuzxyw->IX', t1_aaae, v_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyza,Iwua,Xuzywx->IX', t1_aaae, v_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyza,Iwua,Xuzyxw->IX', t1_aaae, v_caae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= 1/2 * einsum('a,Iiab,ixab,Xx->IX', e_extern, t1_ccee, t1_caee, rdm_ca, optimize = einsum_type)
    V1 += einsum('a,Iiab,ixba,Xx->IX', e_extern, t1_ccee, t1_caee, rdm_ca, optimize = einsum_type)
    V1 += einsum('a,Iiba,ixab,Xx->IX', e_extern, t1_ccee, t1_caee, rdm_ca, optimize = einsum_type)
    V1 -= 1/2 * einsum('a,Iiba,ixba,Xx->IX', e_extern, t1_ccee, t1_caee, rdm_ca, optimize = einsum_type)
    ...
    V1 -= einsum('a,Ixab,Xyab,xy->IX', e_extern, t1_caee, t1_aaee, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('a,Ixab,Xyba,xy->IX', e_extern, t1_caee, t1_aaee, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('a,Ixab,yzab,Xxyz->IX', e_extern, t1_caee, t1_aaee, rdm_ccaa, optimize = einsum_type)
    ...
    V1 += 1/2 * einsum('a,Ixba,Xyab,xy->IX', e_extern, t1_caee, t1_aaee, rdm_ca, optimize = einsum_type)
    V1 -= einsum('a,Ixba,Xyba,xy->IX', e_extern, t1_caee, t1_aaee, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('a,Ixba,yzab,Xxzy->IX', e_extern, t1_caee, t1_aaee, rdm_ccaa, optimize = einsum_type)
    ...
    V1 -= 1/6 * einsum('a,xyza,Iwau,Xwzuxy->IX', e_extern, t1_aaae, t1_caea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('a,xyza,Iwau,Xwzuyx->IX', e_extern, t1_aaae, t1_caea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('a,xyza,Iwau,Xwzxuy->IX', e_extern, t1_aaae, t1_caea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('a,xyza,Iwau,Xwzxyu->IX', e_extern, t1_aaae, t1_caea, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/3 * einsum('a,xyza,Iwau,Xwzyux->IX', e_extern, t1_aaae, t1_caea, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('a,xyza,Iwau,Xwzyxu->IX', e_extern, t1_aaae, t1_caea, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/2 * einsum('i,Iiab,ixab,Xx->IX', e_core, t1_ccee, t1_caee, rdm_ca, optimize = einsum_type)
    V1 -= einsum('i,Iiab,ixba,Xx->IX', e_core, t1_ccee, t1_caee, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('i,IixX,iy,xy->IX', e_core, t1_ccaa, t1_ca, rdm_ca, optimize = einsum_type)
    V1 -= einsum('i,IixX,iyxz,yz->IX', e_core, t1_ccaa, t1_caaa, rdm_ca, optimize = einsum_type)
    V1 += 1/2 * einsum('i,IixX,iyzw,xyzw->IX', e_core, t1_ccaa, t1_caaa, rdm_ccaa, optimize = einsum_type)
    V1 += 1/2 * einsum('i,IixX,iyzx,yz->IX', e_core, t1_ccaa, t1_caaa, rdm_ca, optimize = einsum_type)
    ...
    V1 -= 1/6 * einsum('xy,Ixaz,wuva,Xvyuwz->IX', h_aa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xy,Ixaz,wuva,Xvyuzw->IX', h_aa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xy,Ixaz,wuva,Xvywuz->IX', h_aa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xy,Ixaz,wuva,Xvywzu->IX', h_aa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xy,Ixaz,wuva,Xvyzuw->IX', h_aa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xy,Ixaz,wuva,Xvyzwu->IX', h_aa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/6 * einsum('xy,zwxa,Iuva,Xuyvwz->IX', h_aa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xy,zwxa,Iuva,Xuyvzw->IX', h_aa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xy,zwxa,Iuva,Xuywvz->IX', h_aa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xy,zwxa,Iuva,Xuywzv->IX', h_aa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xy,zwxa,Iuva,Xuyzvw->IX', h_aa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xy,zwxa,Iuva,Xuyzwv->IX', h_aa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/12 * einsum('Xxyz,Iyaw,uvsa,wvusxz->IX', v_aaaa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,Iyaw,uvsa,wvuszx->IX', v_aaaa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,Iyaw,uvsa,wvuxsz->IX', v_aaaa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,Iyaw,uvsa,wvuxzs->IX', v_aaaa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,Iyaw,uvsa,wvuzsx->IX', v_aaaa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('Xxyz,Iyaw,uvsa,wvuzxs->IX', v_aaaa, t1_caea, t1_aaae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= 1/6 * einsum('Xxyz,iwuy,Iivs,uxzsvw->IX', v_aaaa, t1_caaa, t1_ccaa, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,iwuy,Iivs,uxzswv->IX', v_aaaa, t1_caaa, t1_ccaa, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,iwuy,Iivs,uxzvsw->IX', v_aaaa, t1_caaa, t1_ccaa, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,iwuy,Iivs,uxzvws->IX', v_aaaa, t1_caaa, t1_ccaa, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,iwuy,Iivs,uxzwsv->IX', v_aaaa, t1_caaa, t1_ccaa, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('Xxyz,iwuy,Iivs,uxzwvs->IX', v_aaaa, t1_caaa, t1_ccaa, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= 1/12 * einsum('Xxyz,wuya,Ivsa,wusvxz->IX', v_aaaa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('Xxyz,wuya,Ivsa,wusvzx->IX', v_aaaa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('Xxyz,wuya,Ivsa,wusxvz->IX', v_aaaa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('Xxyz,wuya,Ivsa,wusxzv->IX', v_aaaa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('Xxyz,wuya,Ivsa,wuszvx->IX', v_aaaa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('Xxyz,wuya,Ivsa,wuszxv->IX', v_aaaa, t1_aaae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/12 * einsum('xyzw,Iiux,iv,Xvzuwy->IX', v_aaaa, t1_ccaa, t1_ca, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyzw,Iiux,iv,Xvzuyw->IX', v_aaaa, t1_ccaa, t1_ca, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Iiux,iv,Xvzwuy->IX', v_aaaa, t1_ccaa, t1_ca, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Iiux,iv,Xvzwyu->IX', v_aaaa, t1_ccaa, t1_ca, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Iiux,iv,Xvzyuw->IX', v_aaaa, t1_ccaa, t1_ca, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Iiux,iv,Xvzywu->IX', v_aaaa, t1_ccaa, t1_ca, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= 1/12 * einsum('xyzw,Iuax,va,Xuzvwy->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/6 * einsum('xyzw,Iuax,va,Xuzvyw->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xyzw,Iuax,va,Xuzwvy->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xyzw,Iuax,va,Xuzwyv->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xyzw,Iuax,va,Xuzyvw->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/12 * einsum('xyzw,Iuax,va,Xuzywv->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 -= 1/6 * einsum('xyzw,Ixab,uvab,Xywuvz->IX', v_aaaa, t1_caee, t1_aaee, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixab,uvab,Xywuzv->IX', v_aaaa, t1_caee, t1_aaee, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixab,uvab,Xywvuz->IX', v_aaaa, t1_caee, t1_aaee, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixab,uvab,Xywvzu->IX', v_aaaa, t1_caee, t1_aaee, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixab,uvab,Xywzuv->IX', v_aaaa, t1_caee, t1_aaee, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixab,uvab,Xywzvu->IX', v_aaaa, t1_caee, t1_aaee, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/12 * einsum('xyzw,Ixau,va,Xwyuvz->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixau,va,Xwyuzv->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixau,va,Xwyvuz->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyzw,Ixau,va,Xwyvzu->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixau,va,Xwyzuv->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,Ixau,va,Xwyzvu->IX', v_aaaa, t1_caea, t1_ae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/12 * einsum('xyzw,xa,Iuva,Xuzvwy->IX', v_aaaa, t1_ae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyzw,xa,Iuva,Xuzvyw->IX', v_aaaa, t1_ae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xa,Iuva,Xuzwvy->IX', v_aaaa, t1_ae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xa,Iuva,Xuzwyv->IX', v_aaaa, t1_ae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xa,Iuva,Xuzyvw->IX', v_aaaa, t1_ae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xa,Iuva,Xuzywv->IX', v_aaaa, t1_ae, t1_caae, rdm_cccaaa, optimize = einsum_type)
    ...
    V1 += 1/12 * einsum('xyzw,xuva,Ia,Xvzuwy->IX', v_aaaa, t1_aaae, t1_ce, rdm_cccaaa, optimize = einsum_type)
    V1 -= 1/6 * einsum('xyzw,xuva,Ia,Xvzuyw->IX', v_aaaa, t1_aaae, t1_ce, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xuva,Ia,Xvzwuy->IX', v_aaaa, t1_aaae, t1_ce, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xuva,Ia,Xvzwyu->IX', v_aaaa, t1_aaae, t1_ce, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xuva,Ia,Xvzyuw->IX', v_aaaa, t1_aaae, t1_ce, rdm_cccaaa, optimize = einsum_type)
    V1 += 1/12 * einsum('xyzw,xuva,Ia,Xvzywu->IX', v_aaaa, t1_aaae, t1_ce, rdm_cccaaa, optimize = einsum_type)
