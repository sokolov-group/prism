...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0],411.8803873, 3)
        self.assertAlmostEqual(e[1],418.8279693, 3)
        self.assertAlmostEqual(e[2],419.6048239, 3)
        self.assertAlmostEqual(e[3],419.7877206, 3)
        self.assertAlmostEqual(e[4],419.8766752, 3)
        self.assertAlmostEqual(e[5],421.6180612, 3)

        self.assertAlmostEqual(p[0], 1.4681705, 4)
        self.assertAlmostEqual(p[1], 0.       , 4)
        self.assertAlmostEqual(p[2], 0.0019426, 4)
        self.assertAlmostEqual(p[3], 0.       , 4)
        self.assertAlmostEqual(p[4], 0.0000000, 4)
