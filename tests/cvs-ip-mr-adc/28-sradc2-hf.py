...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mf.e_tot, -100.033466082098, 6)

    def test_prism(self):

        e, p, x = mr_adc.kernel()

        self.assertAlmostEqual(e[0], 693.2697, 4)
        self.assertAlmostEqual(e[1], 734.6396, 4)
        self.assertAlmostEqual(e[2], 734.6396, 4)
        self.assertAlmostEqual(e[3], 734.6396, 4)

        self.assertAlmostEqual(p[0], 1.534093, 4)
