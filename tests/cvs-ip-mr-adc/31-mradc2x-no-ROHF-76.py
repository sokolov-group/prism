...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot, -129.36667950346, 5)
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 411.9501, 3)
        self.assertAlmostEqual(e[1], 418.9878, 3)
        self.assertAlmostEqual(e[2], 419.4437, 3)
        self.assertAlmostEqual(e[3], 419.6474, 3)

        self.assertAlmostEqual(p[0],  1.5098378, 4)
        self.assertAlmostEqual(p[1],  0.0000001, 4)
