...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot, -76.1682627916100, 6)
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 545.52587066, 4)
        self.assertAlmostEqual(e[1], 574.30556835, 4)
        self.assertAlmostEqual(e[2], 574.30556835, 4)
        self.assertAlmostEqual(e[3], 574.30556835, 4)

        self.assertAlmostEqual(p[0], 1.62020560, 4)
