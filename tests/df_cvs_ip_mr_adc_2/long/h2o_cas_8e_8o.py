...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 545.52589658, 4)
        self.assertAlmostEqual(e[1], 574.30586212, 4)
        self.assertAlmostEqual(e[2], 574.30586212, 4)
        self.assertAlmostEqual(e[3], 574.30586212, 4)

        self.assertAlmostEqual(p[0], 1.62020754, 4)
        self.assertAlmostEqual(p[1], 0.00000000, 4)
        self.assertAlmostEqual(p[2], 0.00000001, 4)
