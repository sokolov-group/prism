...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0],  32.50433316, 3)
        self.assertAlmostEqual(e[1],  32.58933599, 3)
        self.assertAlmostEqual(e[2],  32.58933659, 3)
        self.assertAlmostEqual(e[3],  37.02651174, 3)
        self.assertAlmostEqual(e[4],  37.74700854, 3)
        self.assertAlmostEqual(e[5],  38.01602241, 3)

        self.assertAlmostEqual(p[0], 1.17575418, 4)
        self.assertAlmostEqual(p[1], 0.00015446, 2)
        self.assertAlmostEqual(p[2], 0.00030891, 2)
        self.assertAlmostEqual(p[3], 0.        , 4)
        self.assertAlmostEqual(p[4], 0.03141987, 4)
