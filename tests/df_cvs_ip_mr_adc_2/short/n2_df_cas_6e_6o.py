...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0],  413.29188747, 4)
        self.assertAlmostEqual(e[1],  413.37803581, 4)
#        self.assertAlmostEqual(e[2],  435.6580891 , 4)
#        self.assertAlmostEqual(e[3],  435.69469624, 4)
#        self.assertAlmostEqual(e[4],  435.76877732, 4)
#        self.assertAlmostEqual(e[5],  437.2939246 , 4)
#        self.assertAlmostEqual(e[6],  437.2939246 , 4)
#        self.assertAlmostEqual(e[7],  437.29392511, 4)
#        self.assertAlmostEqual(e[8],  437.29392511, 4)
#        self.assertAlmostEqual(e[9],  437.37035028, 4)
#        self.assertAlmostEqual(e[10], 437.37035028, 4)
#        self.assertAlmostEqual(e[11], 437.37035079, 4)
