...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        ...
        self.assertAlmostEqual(mc.e_cas, -6.55613502287288, 6)

    def test_prism(self):

        e, p, x = mr_adc.kernel()

        self.assertAlmostEqual(e[0], 540.27312315, 4)
        self.assertAlmostEqual(e[1], 575.31198103, 4)
        self.assertAlmostEqual(e[2], 575.31198103, 4)
        self.assertAlmostEqual(e[3], 575.31198103, 4)

        self.assertAlmostEqual(p[0], 1.51205037, 4)
