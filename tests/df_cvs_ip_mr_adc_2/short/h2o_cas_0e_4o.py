...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 539.82734946, 4)
        self.assertAlmostEqual(e[1], 574.76837407, 4)
        self.assertAlmostEqual(e[2], 574.76837407, 4)
        self.assertAlmostEqual(e[3], 574.76837407, 4)

        self.assertAlmostEqual(p[0], 1.51974226, 4)
        self.assertAlmostEqual(p[1], 0.00000004, 4)
        self.assertAlmostEqual(p[2], 0.00000002, 4)
        self.assertAlmostEqual(p[3], 0.00000013, 4)
