...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 539.82896759, 4)
        self.assertAlmostEqual(e[1], 574.77062271, 4)
        self.assertAlmostEqual(e[2], 574.77062271, 4)
        self.assertAlmostEqual(e[3], 574.77062271, 4)

        self.assertAlmostEqual(p[0], 1.51980289, 4)
        self.assertAlmostEqual(p[1], 0.00000013, 4)
        self.assertAlmostEqual(p[2], 0.00000000, 4)
        self.assertAlmostEqual(p[3], 0.00000005, 4)
