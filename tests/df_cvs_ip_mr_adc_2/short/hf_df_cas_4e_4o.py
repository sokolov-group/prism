...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 693.67686482, 4)
        self.assertAlmostEqual(e[1], 735.43457962, 4)
        self.assertAlmostEqual(e[2], 735.43457962, 4)
        self.assertAlmostEqual(e[3], 735.43457962, 4)
