...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot,  -451.422393237740, 6)
        self.assertAlmostEqual(mc.e_cas,  -3.36152742085022, 6)
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e_tot[0], -453.380723576323, 5)
        self.assertAlmostEqual(e_tot[1], -453.228057545259, 5)
        self.assertAlmostEqual(e_tot[2], -453.154915433034, 5)
        self.assertAlmostEqual(e_tot[3], -453.119453932060, 5)
        
        self.assertAlmostEqual(e_corr[0], -1.3189530532159, 5)
        self.assertAlmostEqual(e_corr[1], -1.3076134519199, 5)
        self.assertAlmostEqual(e_corr[2], -1.3037780509503, 5)
        self.assertAlmostEqual(e_corr[3], -1.3289760427421, 5)
        
        self.assertAlmostEqual(osc[0], 0.0, 5)
        self.assertAlmostEqual(osc[1], 0.0, 5)
        self.assertAlmostEqual(osc[2], 0.11752648, 5)
