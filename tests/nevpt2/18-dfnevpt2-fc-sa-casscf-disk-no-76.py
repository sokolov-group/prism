...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e_tot[0], -129.574421622874, 5)
        self.assertAlmostEqual(e_tot[1], -129.574421622861, 5)
        self.assertAlmostEqual(e_tot[2], -129.323516275273, 5)
        self.assertAlmostEqual(e_tot[3], -129.323516275271, 5)
        self.assertAlmostEqual(e_tot[4], -129.287568008749, 5)
        self.assertAlmostEqual(e_tot[5], -129.287568008749, 5)
        self.assertAlmostEqual(e_tot[6], -129.330152379172, 5)
        
        self.assertAlmostEqual(osc[0], 0.0, 5)
        self.assertAlmostEqual(osc[1], 0.0, 5)
        self.assertAlmostEqual(osc[2], 0.0, 5)
        self.assertAlmostEqual(osc[3], 0.00138304, 5)
        self.assertAlmostEqual(osc[4], 0.00138304, 5)
        self.assertAlmostEqual(osc[5], 0.0, 5)
