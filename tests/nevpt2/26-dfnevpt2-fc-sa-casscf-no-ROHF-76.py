...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot, -129.062246097696, 6)
        self.assertAlmostEqual(mc.e_cas, -15.520229301908, 6)

    def test_prism(self):

        e_tot, e_corr, osc = nevpt.kernel()

        self.assertAlmostEqual(e_tot[0], -129.574421641931, 6)
        self.assertAlmostEqual(e_tot[1], -129.574421641872, 6)
        self.assertAlmostEqual(e_tot[2], -129.323516273123, 6)
        self.assertAlmostEqual(e_tot[3], -129.323516273123, 6)
        self.assertAlmostEqual(e_tot[4], -129.287567987601, 6)
        self.assertAlmostEqual(e_tot[5], -129.287567987600, 6)
        self.assertAlmostEqual(e_tot[6], -129.330152336200, 6)
        ...
        self.assertAlmostEqual(osc[5], 0.00138304, 6)
