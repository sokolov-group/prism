...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e_tot[0], -1792.202314553557, 5)
        self.assertAlmostEqual(e_tot[1], -1792.202314553556, 5)
        self.assertAlmostEqual(e_tot[2], -1792.098895453796, 5)
        self.assertAlmostEqual(e_tot[3], -1792.098895453796, 5)
        self.assertAlmostEqual(e_tot[4], -1792.097655010425, 5)
        self.assertAlmostEqual(e_tot[5], -1792.097655010424, 5)
        
        self.assertAlmostEqual(osc[0], 0.0, 4)
        self.assertAlmostEqual(osc[1], 0.05263607, 4)
        self.assertAlmostEqual(osc[2], 0.05267540, 4)
        self.assertAlmostEqual(osc[3], 0.05329007, 4)
        self.assertAlmostEqual(osc[4], 0.05329711, 4)
