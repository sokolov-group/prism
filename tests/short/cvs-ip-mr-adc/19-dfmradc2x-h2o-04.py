...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 540.4842, 4)
        self.assertAlmostEqual(e[1], 575.5523, 4)
        self.assertAlmostEqual(e[2], 578.0368, 4)
        self.assertAlmostEqual(e[3], 578.8392, 4)

        self.assertAlmostEqual(p[0], 1.573805, 4)
