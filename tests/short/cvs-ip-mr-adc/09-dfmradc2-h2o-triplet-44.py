...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 33.9523, 3)
        self.assertAlmostEqual(e[1], 33.9523, 3)
        self.assertAlmostEqual(e[2], 34.1769, 3)
        self.assertAlmostEqual(e[3], 38.5541, 3)
        self.assertAlmostEqual(e[4], 39.3206, 3)
        self.assertAlmostEqual(e[5], 39.3702, 3)
