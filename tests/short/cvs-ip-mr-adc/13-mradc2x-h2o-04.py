...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot, -76.026653661914, 6)
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 540.4853, 4)
        self.assertAlmostEqual(e[1], 575.5547, 4)
        self.assertAlmostEqual(e[2], 578.0377, 4)
        self.assertAlmostEqual(e[3], 578.8414, 4)

        self.assertAlmostEqual(p[0], 1.573830, 4)
