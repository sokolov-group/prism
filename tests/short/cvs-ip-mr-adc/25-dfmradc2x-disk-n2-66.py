...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0],  411.8963, 4)
        self.assertAlmostEqual(e[1],  411.9781, 4)
        self.assertAlmostEqual(e[2],  426.8185, 4)
        self.assertAlmostEqual(e[3],  428.4417, 4)

        self.assertAlmostEqual(p[0],  1.489950, 4)
        self.assertAlmostEqual(p[1],  1.488019, 4)
