...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 694.8564, 4)
        self.assertAlmostEqual(e[1], 734.4370, 4)
        self.assertAlmostEqual(e[2], 734.4370, 4)
        self.assertAlmostEqual(e[3], 736.9955, 4)

        self.assertAlmostEqual(p[0], 1.616787, 4)
