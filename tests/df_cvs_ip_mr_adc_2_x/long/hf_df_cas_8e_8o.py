...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot, -100.165256670187, 6)
        self.assertAlmostEqual(mc.e_cas, -28.7307606057048, 6)

    def test_prism(self):

        e, p, x = mr_adc.kernel()

        self.assertAlmostEqual(e[0], 697.50427732, 4)
        self.assertAlmostEqual(e[1], 719.26696713, 4)
        self.assertAlmostEqual(e[2], 720.51246184, 4)
        self.assertAlmostEqual(e[3], 723.71429589, 4)

        self.assertAlmostEqual(p[0], 1.41473826, 4)
