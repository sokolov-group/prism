...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 542.86589945, 4)
        self.assertAlmostEqual(e[1], 560.02838683, 4)
        self.assertAlmostEqual(e[2], 561.40243893, 4)
        self.assertAlmostEqual(e[3], 563.88377714, 4)

        self.assertAlmostEqual(p[0], 1.38165171, 4)
        self.assertAlmostEqual(p[1], 0.00000000, 4)
        self.assertAlmostEqual(p[2], 0.000002  , 4)
