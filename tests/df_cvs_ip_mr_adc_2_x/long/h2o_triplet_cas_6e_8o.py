...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0],  22.8241282, 3)
        self.assertAlmostEqual(e[1],  23.1531383, 3)
        self.assertAlmostEqual(e[2],  33.0467604, 3)
        self.assertAlmostEqual(e[3],  34.3911201, 3)
        self.assertAlmostEqual(e[4],  35.3037886, 3)
        self.assertAlmostEqual(e[5],  37.8134118, 3)

        self.assertAlmostEqual(p[0],  0.00038855, 4)
        self.assertAlmostEqual(p[1],  0.        , 4)
        self.assertAlmostEqual(p[2],  1.34315388, 4)
        self.assertAlmostEqual(p[3],  0.00000579, 4)
        self.assertAlmostEqual(p[4],  0.10991912, 4)
        self.assertAlmostEqual(p[5],  0.00000244, 4)
