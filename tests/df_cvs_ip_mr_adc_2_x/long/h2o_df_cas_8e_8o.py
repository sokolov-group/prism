...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        self.assertAlmostEqual(mc.e_tot, -76.1682627916120, 6)
        self.assertAlmostEqual(mc.e_cas, -24.0259358389361, 6)

    def test_prism(self):

        e, p, x = mr_adc.kernel()

        self.assertAlmostEqual(e[0], 542.86578951, 4)
        self.assertAlmostEqual(e[1], 560.02928679, 4)
        self.assertAlmostEqual(e[2], 561.40278992, 4)
        self.assertAlmostEqual(e[3], 563.88443449, 4)

        self.assertAlmostEqual(p[0], 1.38163979, 4)
