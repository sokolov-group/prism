...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 540.86129559, 4)
        self.assertAlmostEqual(e[1], 576.0210991 , 4)
        self.assertAlmostEqual(e[2], 578.43715307, 4)
        self.assertAlmostEqual(e[3], 579.2307391 , 4)

        self.assertAlmostEqual(p[0], 1.56908976, 4)
