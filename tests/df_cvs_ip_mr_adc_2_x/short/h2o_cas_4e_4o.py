...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 541.46805816, 4)
        self.assertAlmostEqual(e[1], 572.29780233, 4)
        self.assertAlmostEqual(e[2], 572.62443706, 4)
        self.assertAlmostEqual(e[3], 573.13706674, 4)
        self.assertAlmostEqual(e[4], 574.27201581, 4)
#        self.assertAlmostEqual(e[5], 574.31160448, 4)
#        self.assertAlmostEqual(e[6], 574.87480689, 4)
#        self.assertAlmostEqual(e[7], 575.14008399, 4)

        self.assertAlmostEqual(p[0], 1.55313053, 4)
        self.assertAlmostEqual(p[1], 0.00000000, 4)
        self.assertAlmostEqual(p[2], 0.00000000, 4)
        self.assertAlmostEqual(p[3], 0.01404879, 4)
