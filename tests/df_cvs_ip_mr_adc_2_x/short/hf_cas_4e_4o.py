...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 695.36072583, 4)
        self.assertAlmostEqual(e[1], 735.49881078, 4)
        self.assertAlmostEqual(e[2], 735.49881079, 4)
        self.assertAlmostEqual(e[3], 738.05375212, 4)

        self.assertAlmostEqual(p[0], 1.60960124, 4)
