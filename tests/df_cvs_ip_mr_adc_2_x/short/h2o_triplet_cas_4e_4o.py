...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e[0], 26.00896205, 3)
        self.assertAlmostEqual(e[1], 26.05371103, 3)
        self.assertAlmostEqual(e[2], 34.13748274, 3)
        self.assertAlmostEqual(e[3], 35.99829605, 3)
        self.assertAlmostEqual(e[4], 37.68666285, 3)
        self.assertAlmostEqual(e[5], 38.11922372, 3)

        self.assertAlmostEqual(p[0], 0.00037452, 4)
        self.assertAlmostEqual(p[1], 0.        , 4)
        self.assertAlmostEqual(p[2], 1.32352447, 4)
        self.assertAlmostEqual(p[3], 0.00000288, 4)
        self.assertAlmostEqual(p[4], 0.00008958, 4)
        self.assertAlmostEqual(p[5], 0.08577336, 4)
