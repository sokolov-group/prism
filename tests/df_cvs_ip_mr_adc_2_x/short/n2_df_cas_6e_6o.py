...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        ...
        self.assertAlmostEqual(mc.e_cas, -13.6479740955807, 6)

    def test_prism(self):

        e, p, x = mr_adc.kernel()

        self.assertAlmostEqual(e[0],  412.02647525, 4)
        self.assertAlmostEqual(e[1],  412.11011049, 4)
        self.assertAlmostEqual(e[2],  427.08565146, 4)
        self.assertAlmostEqual(e[3],  427.08570367, 4)
        self.assertAlmostEqual(e[4],  427.14844238, 4)
        self.assertAlmostEqual(e[5],  427.14849428, 4)
        self.assertAlmostEqual(e[6],  428.27384918, 4)
        self.assertAlmostEqual(e[7],  428.71499354, 4)
        self.assertAlmostEqual(e[8],  428.71506419, 4)
        self.assertAlmostEqual(e[9],  428.73898065, 4)
        self.assertAlmostEqual(e[10], 428.73904916, 4)
        self.assertAlmostEqual(e[11], 428.75347167, 4)

        self.assertAlmostEqual(p[0],  1.48848015, 4)
        self.assertAlmostEqual(p[1],  1.48654873, 4)
