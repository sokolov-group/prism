...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        ...
        self.assertAlmostEqual(mc.e_cas, -7.44246652260736, 6)

    def test_prism(self):

        e, p, x = mr_adc.kernel()

        self.assertAlmostEqual(e[0], 695.36120985, 4)
        self.assertAlmostEqual(e[1], 735.49989897, 4)
        self.assertAlmostEqual(e[2], 735.4998996 , 4)
        self.assertAlmostEqual(e[3], 738.05388042, 4)

        self.assertAlmostEqual(p[0], 1.60960064, 4)
