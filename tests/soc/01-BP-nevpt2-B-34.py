...
class KnownValues(unittest.TestCase):
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e_tot[0], -24.610611883802, 5)
        self.assertAlmostEqual(e_tot[1], -24.610611883801, 5)
        self.assertAlmostEqual(e_tot[2], -24.610544838475, 5)
        self.assertAlmostEqual(e_tot[3], -24.610544838475, 5)
        self.assertAlmostEqual(e_tot[4], -24.610544836979, 5)
        self.assertAlmostEqual(e_tot[5], -24.610544836979, 5)
