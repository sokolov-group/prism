...
class KnownValues(unittest.TestCase):
    ...
    def test_pyscf(self):
        ...
        self.assertAlmostEqual(mc.e_cas,   -16.1552705282706, 5)
    ...
    def test_prism(self):
        ...
        self.assertAlmostEqual(e_tot[0],     -515.612445958043   , 5)
        self.assertAlmostEqual(e_tot[1],     -515.612445958043   , 5)
        self.assertAlmostEqual(e_tot[2],     -515.612445958043   , 5)
