...
class PYSCF:
    ...
    def __init__(self, mf, mc = None, opt_einsum = False):
        ...
        if mc is None:
            ...
            self.absorb_h1e = fci.direct_spin1.absorb_h1e
            self.apply_2e_operator = fci.direct_spin1.contract_2e

            from pyscf import lib
            self.davidson = lib.linalg_helper.davidson1
            self.gen_x0 = lib.linalg_helper._gen_x0
            self.eigs_cmplx2real = lib.linalg_helper._eigs_cmplx2real
        ...
        # Dipole moments
        self.dm_ao    = mf.mol.intor_symmetric("int1e_r", comp = 3)
    ...
    def transform_2e_integrals(self, mo_1, mo_2, mo_3, mo_4):

        from pyscf.ao2mo import general

        return general(self.v2e_ao, (mo_1, mo_2, mo_3, mo_4), compact=False)
